...
public class FlyCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(sender instanceof Player){
            ...
            String onMessage = ChatColor.translateAlternateColorCodes('&', config.getString("MESSAGES.FLY_ENABLED"));
            String offMessage = ChatColor.translateAlternateColorCodes('&', config.getString("MESSAGES.FLY_DISABLED"));
